...
//        }
        ...
        //通过关联表查到属于用户的权限，放进authorizationInfo
        List<SysUserRole> sysUserRoles=sysUserRoleMapper.selectByUserId(userInfo.getUid());
...
//        List<SysRolePermission> sysRolePermissions=sysRolePermissionMapper.selectByRoleId()
//
